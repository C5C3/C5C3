...
The documentation is published as a static site via [GitHub Pages](https://c5c3.github.io/C5C3/) using [VitePress](https://vitepress.dev/).
...
Then open <http://localhost:5173/c5c3/>.
