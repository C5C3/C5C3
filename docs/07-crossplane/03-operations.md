...
Crossplane is deployed and managed via FluxCD in the Management Cluster. For general FluxCD concepts and bootstrap procedures, see [GitOps / FluxCD](../05-deployment/01-gitops-fluxcd/index.md).
...
| **GitOps Integration**    | All claims and compositions are stored in Git and reconciled via [FluxCD](../05-deployment/01-gitops-fluxcd/index.md) |
...
The following structure shows how Crossplane resources and tenant claims are organized in the GitOps repository. For the general repository layout and FluxCD configuration, see [GitOps / FluxCD](../05-deployment/01-gitops-fluxcd/index.md).
