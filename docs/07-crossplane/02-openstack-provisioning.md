...
Crossplane creates the required Ceph resources in the Storage cluster when an OpenStack cluster is provisioned. For details on the storage architecture, see [Storage Architecture](../04-architecture/06-storage.md).
