...
For details on the CRDs consumed by this model, see [CRDs](../04-architecture/01-crds.md). For the overall architecture, see [Architecture Overview](../02-architecture-overview.md).
...
See also: [GitOps / FluxCD](../05-deployment/01-gitops-fluxcd/index.md) for how Crossplane is deployed via FluxCD in the Management Cluster.
