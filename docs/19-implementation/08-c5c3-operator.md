...
For the high-level architecture, see [Control Plane — C5C3 Operator](../03-components/01-control-plane.md#c5c3-operator). For CRD definitions, see [CRDs](../04-crds.md).
...
When infrastructure is managed externally (see [Brownfield Integration](../16-brownfield-integration.md)), service CRs use explicit endpoints instead of `clusterRef`:
