...
│  │  See also: [Observability](../06-operations/02-observability/)                         │  │
│  └────────────────────────────────────────────────────────────────────────┘  │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
                                         │
...
For the cross-cluster communication paths, see [Component Interaction](./02-component-interaction.md).
...
For the RemoteCluster and RemoteArbiter CRD definitions, see [CRDs](./01-crds.md#remotecluster-crd-cephc5c3iov1alpha1). For HA considerations of the storage layer, see [High Availability](./04-high-availability.md).
