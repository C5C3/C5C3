...
For the Hypervisor CRD that represents compute hosts, see [CRDs](./01-crds.md#hypervisor-crd-hypervisorc5c3iov1). For VM placement in the context of eviction and migration, see [Hypervisor Lifecycle](./03-hypervisor-lifecycle.md#eviction-process).
...
For the core CobaltCore CRDs (Hypervisor, Eviction, Migration, etc.), see [CRDs](./01-crds.md).
